...
var recursorMetricDescriptions = map[string]string{
	...
	"auth-zone-queries":           "counts the number of queries to locally hosted authoritative zones (auth-zones) since starting",
	...
	"ecs-queries":                 "number of outgoing queries adorned with an EDNS Client Subnet option (since 4.1)",
	"ecs-responses":               "number of responses received from authoritative servers with an EDNS Client Subnet option we used (since 4.1)",
